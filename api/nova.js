...
export default async function handler(req, res) {
  ...
  const system =
    ...
    + "display currency. Subscriptions list a cost and billing period; income lists recurring "
    + "income sources with an amount and period (their cash-flow counterpart to subscriptions); "
    + "orders are incoming purchases; wishlist items are things they're saving for.\n"
